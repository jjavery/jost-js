...
exports.createReaderMachine = void 0;
const fsm_1 = require("@xstate/fsm");
function signTags(context) {
    return context.signTags();
}
function signContent(context) {
    return context.signContent();
}
function dontSignTags(context) {
    return !context.signTags();
}
function dontSignTagsOrContent(context) {
    return !context.signTags() || !context.signContent();
}
function signTagsAndDontSignContent(context) {
    return context.signTags() && !context.signContent();
}
const config = {
    id: 'jost',
...
function createReaderMachine(context) {
